...
import { DiscordActionRow, DiscordAttachments, DiscordButton, DiscordCode, DiscordEmbed, DiscordEmbedDescription, DiscordMessage, DiscordMention, DiscordReply } from "@skyra/discord-components-react";
import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';
import { CustomMessages } from "@site/src/components/CustomMessages"

### Why?
The bot has been designed to work with both free and paid maps, tho no maps are paid for now.

### How?
Open the #downloads channel, and find the map (you can use the search bar at the top of the screen) you'd like to get. Then click the claim button and *voilà*!
...
<CustomMessages>
    ...
    <DiscordMessage ephemeral author="EarthMaker Assistant" roleColor="#f1c40f" bot avatar="/img/assistant.webp">
        ...
        <DiscordEmbed color="#99FFCC" slot="embeds" embedTitle="Success!">
            <DiscordEmbedDescription slot="description">
                You've unlocked the Lorem Ipsum map for free! Press the "Get" button again to download.
            </DiscordEmbedDescription>
        </DiscordEmbed>
    </DiscordMessage>
</CustomMessages>
...
<CustomMessages>
    <DiscordMessage author="EarthMaker Assistant" roleColor="#f1c40f" bot avatar="/img/assistant.webp">
        ...
        <DiscordAttachments slot="components">
            <DiscordActionRow>
                <DiscordButton type="primary" emoji-name="⬇️" emoji="/img/down-arrow.png" onClick={() => window.open("https://www.youtube.com/watch?v=dQw4w9WgXcQ")}>Get</DiscordButton>
                <DiscordButton type="success" url="javascript:void()" onClick={() => window.open("https://www.youtube.com/watch?v=dQw4w9WgXcQ")}>Learn more</DiscordButton>
            </DiscordActionRow>
        </DiscordAttachments>
    </DiscordMessage>
    <DiscordMessage ephemeral author="EarthMaker Assistant" roleColor="#f1c40f" bot avatar="/img/assistant.webp">
        ...
        <DiscordAttachments slot="components">
            <DiscordActionRow>
                ...
                <DiscordButton type="secondary" emoji-name="➡️" emoji="/img/right-arrow.png" onClick={() => window.open("https://www.youtube.com/watch?v=dQw4w9WgXcQ")}>Download next</DiscordButton>
            </DiscordActionRow>
        </DiscordAttachments>
    </DiscordMessage>
</CustomMessages>
